...
def proxy_dependencies():
    go_repository(
        name = "ag_pack_amqp",
        importpath = "pack.ag/amqp",
        sum = "h1:4PfqFQ28BTzS1ghmnaADX14yktqA+iU8H5t4lkTZxaA=",
        version = "v0.12.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:QJDJubh0OEcpeGjC7/8uF9tt4e39U/Ya1uyK+itnNPQ=",
        version = "v0.0.0-20211001041855-01bcc9b48dfe",
    )
    ...
    go_repository(
        ...
        sum = "h1:8bVUGXXkR3+YQNwuFof3lLxSJMLtrscHJfGI6ZIBRD0=",
        version = "v1.0.5",
    )
    go_repository(
